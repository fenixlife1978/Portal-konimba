...
// Componente para mostrar método de pago actual
      ...
      case 'display':
        return (
          <DisplayPaymentMethod 
            ...
            onDelete={handleDeleteAndChange} 
          />
        );
      ...
      case 'create':
        return (
          <Card>
            <CardHeader>
              <CardTitle>
                {viewState === 'edit' ? 'Modificar Método de Pago' : 'Configurar Nuevo Método de Pago'}
              </CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 border rounded-lg bg-muted/30">
                ...
                <div className="space-y-2">
                  ...
                  <Select 
                    onValueChange={(val) => handlePaymentInputChange('paymentMethod', val)} 
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      {(formData.country === 'VE' || formData.country === 'CO') && (
              ...
              {/* Transferencia */}
              <div className={formData.paymentMethod === 'transferencia' ? 'block' : 'hidden'}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Select onValueChange={(val) => handlePaymentInputChange('bank', val)} value={formData.bank}>
                        ...
                        <SelectContent>
                          {formData.country === 'VE' && banksVe.map(b => (
                            <SelectItem key={b.id} value={b.name}>{b.name}</SelectItem>
                          ))}
                          {formData.country === 'CO' && banksCo.map(b => (
                    ...
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        placeholder={formData.country === 'VE' ? '20 dígitos para Venezuela' : 'Número de cuenta para Colombia'} 
                        maxLength={formData.country === 'VE' ? 20 : undefined} 
                      />
              ...
              {/* Pago Móvil */}
              <div className={formData.paymentMethod === 'pagoMovil' && formData.country === 'VE' ? 'block' : 'hidden'}>
                <div className='space-y-4'>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Input 
                          value={formData.mobilePaymentPhoneNumber} 
                          onChange={(e) => handlePaymentInputChange('mobilePaymentPhoneNumber', e.target.value)} 
                          placeholder="XXXXXXX" 
                          maxLength={7} 
                        />
                      </div>
                      {errors.mobilePaymentPhoneCode && !errors.mobilePaymentPhoneNumber && (
                        <p className="text-sm text-destructive">{errors.mobilePaymentPhoneCode}</p>
                      )}
                      {errors.mobilePaymentPhoneNumber && (
                        <p className="text-sm text-destructive">{errors.mobilePaymentPhoneNumber}</p>
                      )}
                    </div>
                    <div className="space-y-2 col-span-1 md:col-span-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Input 
                          value={formData.mobilePaymentIdNumber} 
                          onChange={(e) => handlePaymentInputChange('mobilePaymentIdNumber', e.target.value)} 
                          placeholder="12345678" 
                        />
                      </div>
                      {errors.mobilePaymentIdPrefix && !errors.mobilePaymentIdNumber && (
                        <p className="text-sm text-destructive">{errors.mobilePaymentIdPrefix}</p>
                      )}
                      {errors.mobilePaymentIdNumber && (
                        <p className="text-sm text-destructive">{errors.mobilePaymentIdNumber}</p>
                      )}
                    </div>
                  </div>
                </div>
              ...
              {/* USDT */}
              <div className={formData.paymentMethod === 'usdt' ? 'block' : 'hidden'}>
                <div className='space-y-4'>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        onChange={(e) => handlePaymentInputChange('usdtAddress', e.target.value)} 
