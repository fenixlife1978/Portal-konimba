          ...
          {paymentMethod === 'pagoMovil' && country === 'VE' && (
            <>
              ...
              <div className="space-y-2">
                ...
                <Controller name="mobilePaymentPhone" control={control} render={({ field }) => <Input {...field} id="mobilePaymentPhone" placeholder="04XX-XXXXXXX" />} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="mobilePaymentId">Cédula o RIF</Label>
                <Controller name="mobilePaymentId" control={control} render={({ field }) => <Input {...field} id="mobilePaymentId" placeholder="V-12345678" />} />
              </div>
            </>
          )}
          ...
          {paymentMethod === 'transferencia' && (country === 'VE' || country === 'CO') && (
            <>
              ...
              <div className="space-y-2">
                ...
                <Controller name="accountNumber" control={control} render={({ field }) => <Input {...field} id="accountNumber" placeholder="0102..." />} />
              </div>
            </>
          )}
